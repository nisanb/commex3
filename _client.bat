...
@javac -classpath lib/json-simple-1.1.1.jar -sourcepath src src/il/ac/haifa/is/datacomms/hw3/clientside/*.java src/il/ac/haifa/is/datacomms/hw3/util/*.java -d bin

:: runs compiled client main class.
@java -cp bin;lib/json-simple-1.1.1.jar il.ac.haifa.is.datacomms.hw3.clientside.ClientDriver
